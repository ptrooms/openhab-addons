 ...
 */
package org.openhab.binding.avmfritz2.internal.hardware.callbacks;
...
import org.openhab.binding.avmfritz2.internal.ahamodel.DevicelistModel;
...
import org.openhab.binding.avmfritz2.internal.util.JAXBUtils;
...
public class FritzAhaDiscoveryCallback extends FritzAhaReauthCallback {
    ...
    public FritzAhaDiscoveryCallback(FritzAhaWebInterface webIface, AVMFritzDiscoveryService service) {
		...
		logger.debug("FritzAhaDiscoveryCallback super path={} webIface={} , service={}", WEBSERVICE_PATH, webIface, service);
    }
